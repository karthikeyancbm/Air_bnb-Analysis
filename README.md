...
* This project aims at Extracting, Cleaning, Performing the EDA, Visualizing it using Streamlit and Creating an interactive dashboard both in Streamlit and Tableau. The dataset is available in the MongoDB Atlas as a Sample Dataset.
